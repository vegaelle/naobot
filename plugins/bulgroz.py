...
class bulgroz(stdPlugin):
    ...
    cadeau_messages = \
        [u"OBTENEZ OFFRE DE MOINS CHER POUR %(produit)s EN CLIQUANT "
         u"LE PAYPAL",
         ...
         u"C'EST GRAND BESOIN DE %(produit)s ???? SANS ATTENTE DEMANDEZ "
         u"LIVRAISON POUR HIER ET RECEVEZ MAINTENANT!! TRÈS RAPIDE SI "
         u"PAYPAL!!!!",
         u"VOUS SAVEZ AVOIR BESOIN DE %(produit)s??? DONC CLIQUE VITE L'OFFRE "
         u"SUR L'ÉCRAN ET REÇOIT %(produit)s CHEZ TOI DANS VOTRE MAISON!",
    ...
    bortz_messages = \
        [u"BORTZ RULEZ !",
         ...
         u"CLIQUEZ LE PAYPAL POUR ABONNEMENT GRATUIT À BLOGZMEYER SUR "
         u"HTTP://WWW.BORTZMEYER.ORG !",
         u"LES RFC SONT EN ILLIMITÉ SUR BLOGZMEYER POUR ADMINISTREMENT DES "
         u"INTERNETZ !"]
    ...
    single_answer = \
        {u"tchouu": "VOYAGEZ TOUTE LA SAISON SUR LE CHEMINEMENT DE FER "
         ...
         u"bite": u"BEAUCOUP DES TAS DE MÂ©GABITES PAR MINUTES ? CLIQUEZ ICI"
                  u" POUR LA FIBRE À CHIBRES ET ENLARGE TA PÉNICHE POUR "
                  u"ENLARGE URANUS."
         }
